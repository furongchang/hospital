...
public class patient_login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            p = conn.prepareStatement("select username,password,name from patient_log where username=? and password=?");
            ...
            if (rs.next()) {
                ...
                req.getSession().setAttribute("patientName",rs.getString("name"));
                req.getSession().setAttribute("patient_begin",begin);
